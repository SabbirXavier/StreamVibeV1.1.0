    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 glass-panel bg-white/[0.03]">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          ...
          <span className="font-black text-2xl tracking-tighter text-chrome italic uppercase">
            ProTip
          </span>
        </Link>
               ...
               {role === 'admin' && (
                 <Link 
                   ...
                   className={cn(
                     ...
                     location.pathname.startsWith('/admin') ? "text-[#00FFFF] drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]" : "text-zinc-400"
                   )}
                 >
                   <ShieldCheck size={16} />
